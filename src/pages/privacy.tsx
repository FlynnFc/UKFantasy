  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        <section className="prose mx-auto mb-20">
          <h1>Privacy policy</h1>
          <h5>Last updated:01/05/2023</h5>
          <p>
          ...
          <p>
            We do use your data to improve the Service. By using the Service,
          ...
          <p>
            ...
            personally identifiable information that will not be used to contact
            you (&apos;Personal Data&apos;). Personally identifiable information
          ...
          <p>
            ...
            information such as browser type, browser version, the pages of our
          ...
          <p>We don&apos;t transfer your data.</p>
