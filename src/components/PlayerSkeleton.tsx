...
const PlayerSkeleton = () => {
  ...
  return (
    <div
      className={`z-0 flex  h-72 w-56 flex-col justify-between overflow-hidden rounded-xl bg-base-200 text-sm shadow-lg ${
        stats && "animate-pulse"
      }`}
      onMouseEnter={() => {
    ...
    >
      <div
        className={` image  justify-center overflow-hidden bg-base-300`}
      ></div>
